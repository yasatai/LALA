...
// 本文の改行位置を文節単位に制御する（語中で折り返さない）
const textPhrases: Record<string, string[]> = {
  '毎日の使いやすさまで考えてくださり職人さんの説明も丁寧でした。': ['毎日の使いやすさまで', '考えてくださり', '職人さんの説明も', '丁寧でした。'],
  '初めてのリフォームでしたが段階ごとに説明があり安心できました。': ['初めての', 'リフォームでしたが', '段階ごとに説明があり', '安心できました。'],
  '細かな要望にも応えていただき毎日の暮らしが快適になりました。': ['細かな要望にも', '応えていただき', '毎日の暮らしが', '快適になりました。'],
  '工事内容や費用を丁寧に説明してくださり納得してお願いできました。': ['工事内容や費用を', '丁寧に説明してくださり', '納得して', 'お願いできました。'],
};
