...
export const promises = [
  {
    number: '01',
    title: '丁寧なヒアリング',
    text: 'ご家族の想いや暮らし方を丁寧に伺い、最適なプランをご提案します。',
  },
  {
    number: '02',
    title: '確かな品質と施工',
    text: '経験豊富な職人が、細かな部分まで品質を確かめて施工します。',
  },
  {
    number: '03',
    title: 'ずっと安心のサポート',
    text: '工事後も安心して暮らせるよう、点検と相談体制を続けます。',
  },
];
...
export const services = [
  {
    number: '01',
    title: '塗装工事',
    text: '外壁・屋根の塗装で、住まいの美しさと耐久性を守ります。',
    image: '/images/service-painting.png',
  },
  {
    number: '02',
    title: '外装工事',
    text: '屋根・外壁・雨樋など、建物の外まわりを整えます。',
    image: '/images/service-exterior.png',
  },
  {
    number: '03',
    title: '内装・水廻り工事',
    text: '水廻りから床・壁・天井まで、暮らしに合わせて空間を一新。',
    image: '/images/service-interior.png',
  },
  {
    number: '04',
    title: '足場・解体',
    text: '安全な足場設置から解体まで、工事の土台を支えます。',
    image: '/images/service-scaffold-demolition.png',
  },
  {
    number: '05',
    title: '床下工事・駆除',
    text: '床下環境を確認し、湿気・害虫対策や必要な補修を行います。',
    image: '/images/service-underfloor.png',
  },
  {
    number: '06',
    title: '店舗・アパート工事',
    text: '店舗や集合住宅の改修を、用途と運営に合わせてご提案します。',
    image: '/images/service-shop-apartment.png',
  },
];
...
export const serviceDetails = [
  ...
  },
  {
    ...
    title: '内装・水廻り工事',
    image: '/images/service-interior.png',
    items: ['浴室工事', 'キッチン工事', 'トイレ工事', '洗面台工事', 'エコキュート', '給油設備機器', 'クロス貼り替え', 'エコカラット', 'フローリング', '畳貼り替え', '襖貼り替え'],
    text: '浴室・キッチン・トイレ・洗面台などの水廻りから、クロス・床・畳・襖まで、現代のライフスタイルとお客様のニーズに合わせて完全自社施工の「高品質・安心価格」にてご対応いたします。',
  },
  {
    number: '04',
    title: '足場・解体',
  ...
  },
  {
    ...
    title: '店舗・アパート工事',
    image: '/images/service-shop-apartment.png',
    items: ['外壁塗装', '外壁貼り替え', '内外装補修', 'クロス貼り替え', '基礎補修', '水廻り全般'],
...
export const works = [
  {
    ...
    before: '/images/works-gallery/20-1.jpg', after: '/images/works-gallery/20-2.jpg',
    text: 'トイレ本体と内装、収納を整えた施工例です。',
  },
  {
    title: '洗面・ランドリーリフォーム', area: '', period: '',
    before: '/images/works-gallery/17-1.jpg', after: '/images/works-gallery/18-2.jpg',
    text: '洗面台とランドリースペースを一体的に整えた施工例です。',
  },
  {
    title: '洗面台リフォーム', area: '', period: '',
    before: '/images/works-gallery/16-1.jpg', after: '/images/works-gallery/16-2.jpg',
    text: '収納力と清掃性を高めた洗面台交換の施工例です。',
  },
  {
    title: 'LDK・キッチンリフォーム', area: '', period: '',
    before: '/images/works-gallery/15-1.jpg', after: '/images/works-gallery/15-2.jpg',
    text: 'キッチンの配置と空間全体を見直した施工例です。',
  },
  {
    title: 'キッチンリフォーム', area: '', period: '',
    before: '/images/works-gallery/14-1.jpg', after: '/images/works-gallery/14-2.jpg',
    text: '壁面と収納を含め、明るく使いやすく整えた施工例です。',
  },
  {
    title: 'キッチン交換', area: '', period: '',
    before: '/images/works-gallery/13-1.jpg', after: '/images/works-gallery/13-2.jpg',
    text: '既存のレイアウトを活かして設備を更新した施工例です。',
  },
  {
    title: '玄関まわりリフォーム', area: '', period: '',
    before: '/images/works-gallery/12-1.jpg', after: '/images/works-gallery/12-2.jpg',
    text: '玄関ドアとアプローチまわりを明るく整えた施工例です。',
  },
  {
    title: '玄関ドア交換', area: '', period: '',
    before: '/images/works-gallery/10-1.jpg', after: '/images/works-gallery/10-2.jpg',
    text: '住まいの印象を変える玄関ドア交換の施工例です。',
  },
  {
    title: 'トタン屋根塗装', area: '', period: '',
    before: '/images/works-gallery/09-1.jpg', after: '/images/works-gallery/09-2.jpg',
    text: '傷みの見られた金属屋根を保護し、美しく仕上げた施工例です。',
  },
  {
    title: 'スレート屋根塗装', area: '', period: '',
    before: '/images/works-gallery/07-1.jpg', after: '/images/works-gallery/07-2.jpg',
    text: '屋根全体を塗り替え、住まいを保護した施工例です。',
  },
  {
    title: 'アパート外装リフォーム', area: '', period: '',
    before: '/images/works-gallery/05-1.jpg', after: '/images/works-gallery/05-2.jpg',
    text: '建物全体の外観を整えたアパート外装の施工例です。',
  },
  {
    title: '平屋住宅の外装塗装', area: '', period: '',
    before: '/images/works-gallery/04-1.jpg', after: '/images/works-gallery/04-2.jpg',
    text: '外壁と付帯部を塗り替え、明るく整えた施工例です。',
  },
  {
    title: '戸建て外装塗装 A', area: '', period: '',
    before: '/images/works-gallery/02-1.jpg', after: '/images/works-gallery/02-2.jpg',
    text: '外壁と付帯部の色調を整えた戸建て住宅の施工例です。',
  },
  {
    title: '戸建て外装塗装 B', area: '', period: '',
    before: '/images/works-gallery/01-1.jpg', after: '/images/works-gallery/01-2.jpg',
    text: '外壁の状態を整え、明るい印象へ仕上げた施工例です。',
  },
  {
    title: '戸建て外装塗装 C', area: '', period: '',
    before: '/images/works-gallery/03-1.jpg', after: '/images/works-gallery/03-2.jpg',
...
export const homeWorks = [
  {
    ...
    area: '',
    period: '',
    before: '/images/works-lala/works-01-roof-before.jpg',
    after: '/images/works-lala/works-01-roof-after.jpg',
  },
  {
    title: 'トタン屋根塗装',
    area: '',
    period: '',
    before: '/images/works-lala/works-02-metal-roof-before.jpg',
    after: '/images/works-lala/works-02-metal-roof-after.jpg',
  },
  {
    title: '玄関まわり改修',
    area: '',
    period: '',
    before: '/images/works-lala/works-03-entrance-before.jpg',
    after: '/images/works-lala/works-03-entrance-after.jpg',
  },
  {
    title: '玄関ドア交換',
    area: '',
    period: '',
    before: '/images/works-lala/works-04-door-before.jpg',
    after: '/images/works-lala/works-04-door-after.jpg',
  },
  {
    title: 'キッチン改修',
    area: '',
    period: '',
    before: '/images/works-lala/works-05-kitchen-before.jpg',
    after: '/images/works-lala/works-05-kitchen-after.jpg',
  },
  {
    title: 'LDK・キッチン改修',
    area: '',
    period: '',
    before: '/images/works-lala/works-06-ldk-before.jpg',
    after: '/images/works-lala/works-06-ldk-after.jpg',
  },
  {
    title: '洗面台交換',
    area: '',
    period: '',
    before: '/images/works-lala/works-07-washstand-before.jpg',
    after: '/images/works-lala/works-07-washstand-after.jpg',
  },
  {
    title: '洗面・ランドリー改修',
    area: '',
    period: '',
    before: '/images/works-lala/works-08-laundry-before.jpg',
    after: '/images/works-lala/works-08-laundry-after.jpg',
  },
];
...
export const voices = [
  {
    ...
    text: '毎日の使いやすさまで考えてくださり、職人さんの説明も丁寧でした。',
  },
  {
    quote: '相談しやすくて安心でした',
    name: '仙台市泉区 M様',
    ...
    text: '初めてのリフォームでしたが、段階ごとに説明があり安心できました。',
  },
  {
    quote: '仕上がりに大満足です。',
    name: '多賀城市 T様',
    ...
    text: '細かな要望にも応えていただき、毎日の暮らしが快適になりました。',
  },
];
